...
this.oInstance=null;this.oFeatures={bPaginate:true,bLengthChange:true,bFilter:true,bSort:true,bInfo:true,bAutoWidth:true,bProcessing:false,bSortClasses:true,bStateSave:false,bServerSide:false,bDeferRender:false};this.oScroll={sX:"",sXInner:"",sY:"",bCollapse:false,bInfinite:false,iLoadGap:100,iBarWidth:0,bAutoCss:true};this.aanFeatures=[];this.oLanguage={sProcessing:"in Bearbeitung...",sLengthMenu:"Zeige _MENU_ Eintr&auml;ge",sZeroRecords:"Keine passenden Datens&auml;tze gefunden",sEmptyTable:"Keine Daten vorhanden in der Tabelle",
sLoadingRecords:"beim Laden...",sInfo:"Zeige _START_ bis _END_ von _TOTAL_ Eintr&auml;ge",sInfoEmpty:"Zeige 0 bis 0 von 0 Eintr&auml;gen",sInfoFiltered:"(gefiltert von _MAX_ Eintr&auml;gen)",sInfoPostFix:"",sSearch:"Suchen:",sUrl:"",oPaginate:{sFirst:"First",sPrevious:"Previous",sNext:"Next",sLast:"Last"},fnInfoCallback:null};this.aoData=[];this.aiDisplay=[];this.aiDisplayMaster=[];this.aoColumns=[];this.aoHeader=[];this.aoFooter=[];this.iNextId=0;this.asDataSearch=[];this.oPreviousSearch={sSearch:"",bRegex:false,
